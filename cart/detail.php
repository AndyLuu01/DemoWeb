...
if (isset($_POST['detail']))
      ...
      $sql = "SELECT * FROM vegetable where VegetableID=1";
...
<div class="card text-center">
  ...
  <div class="d-flex">
      ...
      <div class="p-2 border col-3 ">Image</div>
...
<div class="d-flex">
      ...
      <div class="p-2 border col-3 "><img width="70%" src="<?=$row['Image']?>" alt=""></div>
      <div class="p-2 border col-2 "><?=$row['Amount']?></div>
      <div class="p-2 border flex-grow-1"><?=$row['Price']?></div>
</div>
<?php
